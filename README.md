...
[![Build Status](https://github.com/khulnasoft/go-keychain/actions/workflows/ci.yml/badge.svg)](https://github.com/khulnasoft/go-keychain/actions)
...
```go
import "github.com/khulnasoft/go-keychain"
```
